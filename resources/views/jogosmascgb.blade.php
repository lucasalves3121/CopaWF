...
@section("content")
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="../img/slidegrub1.png" alt="First slide">
    </div>
                    ...
                    <div class="col-lg-12">
                            <div class="bg-primary mb-5 py-3">
                             <h3 class="text-white py-3 px-4 m-0" style="text-align: center;">GRUPO B</h3>
                                <h5 class="text-white py-12 px-4 m-0" style="text-align: center">17/09/2022 | 17:00h</h5>
                            ...
                            <br>
                            <div class="bg-primary mb-5 py-3">
                                <h5 class="text-white py-12 px-4 m-0" style="text-align: center">17/09/2022 | 18:00h</h5>
                                <div class="d-flex justify-content-between border-bottom px-4">
                                <<h5 class="text-white col-lg-4"style=""></h5>                            
                                <<h5 class="text-white col-lg-4"style="text-align: Center;">0   x   0</h5>
                                <<h5 class="text-white col-lg-4"style="text-align: Center;"></h5>
